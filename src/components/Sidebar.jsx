...
// import { ReactComponent as YourSvg } from "../svg/Spotify.svg";

const Sidebar = () => {
  return (
    <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
      <div className="bg-[#121212] h-[15%] rounded flex flex-col justify-around">
        <div className="fill-white flex items-center gap-3 pl-8 text-bold cursor-pointer">
          <SpotifySvg />
        </div>
        <div className="flex items-center gap-0.5 pl-8 cursor-pointer">
